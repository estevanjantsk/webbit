...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post communities_url, params: { community: { description: @community.description, name: @community.name, sidedar: @community.sidedar, title: @community.title } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { description: @community.description, name: @community.name, sidedar: @community.sidedar, title: @community.title } }
